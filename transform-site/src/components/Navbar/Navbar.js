...
function Navbar(props) {
    ...
    //         console.log(link)
    //     if(link.includes('/#')){
    //       console.log(document.getElementById(link.split('/#')[1]))
    ...
    return (
        <div className="Navbar">
            <svg height="60px" width="60px" version="1.1" id="Layer_Pedal" 
                    viewBox="0 0 512 512" >
                <g>
                    <path fill="#f89f73" d="M155.566,349.301C223.442,388.489,256,459.171,256,459.171s-77.49,7.145-145.367-32.044
                        S10.199,317.257,10.199,317.257S87.69,310.112,155.566,349.301z"/>
                    <path fill="#f89f73" d="M401.367,427.127C333.49,466.315,256,459.171,256,459.171s32.558-70.681,100.434-109.87
                        s145.367-32.044,145.367-32.044S469.243,387.938,401.367,427.127z"/>
                </g>
                <g>
                    <path fill="#7fb98d" d="M220.353,297.381C263.948,372.891,256,459.097,256,459.097s-78.631-36.219-122.226-111.729
                        S98.126,185.652,98.126,185.652S176.757,221.871,220.353,297.381z"/>
                    <path fill="#7fb98d" d="M378.226,347.367C334.631,422.878,256,459.097,256,459.097s-7.948-86.206,35.647-161.716
                        s122.226-111.73,122.226-111.73S421.822,271.857,378.226,347.367z"/>
                </g>
                <g>
                    <path fill="#f89f73" d="M307.396,296.772c0,89.65-51.396,162.325-51.396,162.325s-51.396-72.675-51.396-162.324
                        S256,134.447,256,134.447S307.396,207.123,307.396,296.772z"/>
                    <circle fill="#f89f73" cx="173.386" cy="159.883" r="19.888"/>
                    <circle fill="#f89f73" cx="338.613" cy="159.883" r="19.888"/>
                </g>
                <circle fill="#7fb98d" cx="256" cy="72.17" r="19.888"/>
            ...
            <nav className={'Navbar-items'}>
                ...
                {nav_item_list.map((item) => {
                    ...
                    return <NavLink to={item.link} onClick={()=>{ handleMenuClick(item.link);}}>
                        {item.name}
                    </NavLink>
                })}
            </nav>
